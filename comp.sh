...
hp_car "${p0}"
sht12="${R}"
if [ "${sht12}" = "S:str" ]; then PC=11; else PC=12; fi
ACTION=jump; return
;;
10)
sht11="${R}"
...
hp_car "${p0}"
sht16="${R}"
if [ "${sht16}" = "S:list" ]; then PC=15; else PC=16; fi
ACTION=jump; return
;;
13)
sht14="${R}"
...
hp_car "${p0}"
sht26="${R}"
if [ "${sht22}" = "${sht26}" ]; then PC=21; else PC=22; fi
ACTION=jump; return
;;
21)
hp_cdr "${p0}"
...
;;
23)
if [ "${sht27}" != NIL ]; then PC=24; else PC=25; fi
ACTION=jump; return
;;
24)
R="${p0}"; ACTION=ret; return

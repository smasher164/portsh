...
hp_car "${p0}"
sht30="${R}"
if [ "${sht30}" = "S:str" ]; then PC=23; else PC=24; fi
ACTION=jump; return
;;
22)
sht29="${R}"
...
hp_car "${p0}"
sht34="${R}"
if [ "${sht34}" = "S:list" ]; then PC=27; else PC=28; fi
ACTION=jump; return
;;
25)
sht32="${R}"
...
hp_car "${p0}"
sht44="${R}"
if [ "${sht40}" = "${sht44}" ]; then PC=33; else PC=34; fi
ACTION=jump; return
;;
33)
hp_cdr "${p0}"
...
;;
35)
if [ "${sht45}" != NIL ]; then PC=36; else PC=37; fi
ACTION=jump; return
;;
36)
R="${p0}"; ACTION=ret; return
